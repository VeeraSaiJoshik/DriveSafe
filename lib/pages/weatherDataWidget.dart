...
import 'chooseCurrentLocation.dart';
...
class weatherDataWidget extends StatefulWidget {
  ...
  String time;
  weatherDataWidget(this.description, this.data, this.assetAddress,
...
class _weatherDataWidgetState extends State<weatherDataWidget> {
  ...
  void initState() {
    print("here");
    arrivalTime = DateTime.parse(widget.time);
    temperature = widget.data.temp.toInt().toString();
    initStateFunction();
    super.initState();
  }
